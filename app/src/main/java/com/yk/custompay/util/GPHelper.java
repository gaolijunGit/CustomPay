...
import com.yk.custompay.manager.LoginRealizeManager;
import com.yk.custompay.model.Constants;
...
public class GPHelper {
    ...
    private static final String TAG = GPHelper.class.getSimpleName();
    ...
    public GPHelper(Activity activity,
                    ...
                    String sku, Map<String, Object> mParams, OnRechargeListener mListener) {
    ...
    public GPHelper(Activity activity, int mPayTest) {
        this.mActivityRef = new WeakReference<>(activity);
        this.mPayTest = mPayTest;
    }
                ...
                public void onBillingSetupFinished(BillingResult billingResult) {
                    if (billingResult != null) {
                        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                            if (!TextUtils.isEmpty(SPUtil.getString(mActivityRef.get(),
                                    Constants.USER_ID))) {
                                getLTOrderID();
                            } else {
                                mListener.onState(mActivityRef.get(), RechargeResult.failOf(Result.STATE_GP_CREATE_ORDER_FAILED,
    ...
    private void getLTOrderID() {
        ...
        LoginRealizeManager.createOrder(mActivityRef.get(), goods_number,
                mParams,
                        ...
                        if (result != null) {
                            if (result.getResultModel() != null) {
                                if (result.getResultModel().getData() != null) {
                                    if (result.getResultModel().getCode() == 0) {//成功直接支付
